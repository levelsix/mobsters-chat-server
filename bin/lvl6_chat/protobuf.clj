...
;ProtoDefs
(def ChatRoomProtoDef (protodef com.lvl6.chatserver.ChatInfo$ChatRoomProto))
(def ChatMessageProtoDef (protodef com.lvl6.chatserver.ChatInfo$ChatMessageProto))
;event type protodef
